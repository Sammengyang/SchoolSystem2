...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item layui-hide-xs"><a id="nav2" href="\view\student\stu_score.jsp">历史成绩</a></li>
            <li class="layui-nav-item layui-hide-xs"><a id="nav3" href="\view\student\stu_course.jsp">课表</a></li>
            <li class="layui-nav-item layui-hide-xs"><a id="nav4" href="\view\student\stu_leave.jsp">请假申请</a></li>
            <li class="layui-nav-item layui-hide-xs"><a id="nav5" href="\view\student\stu_message.jsp">消息查看</a></li>
            <li class="layui-nav-item layui-hide-xs"><a id="nav6" href="\view\student\stu_repairs.jsp">故障报修</a></li>
            <li class="layui-nav-item">
                <a href="javascript:;">作业</a>
                <dl class="layui-nav-child">
                    <dd><a id="stu_homework" href="\view\student\stu_homework.jsp">查看作业</a></dd>
                    <dd><a id="stu_post_homework" href="\view\student\stu_post_homework.jsp">提交作业</a></dd>
                </dl>
            </li>
            <li class="layui-nav-child">
                <a href="#">sadfsdf</a>
                <dl class="layui-nav-child">
                    <dd><a href="#">sfasadf</a></dd>
                    <dd><a href="#">sfasadf</a></dd>
                </dl>
            </li>
        </ul>
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="padding: 0px;" id="divbody">内容主体区域。记得修改 layui.css 和 js 的路径
            <iframe id="f1" src="\view\student\stu_infor.jsp" width="100%" height="600px"></iframe>
        </div>
    </div>
